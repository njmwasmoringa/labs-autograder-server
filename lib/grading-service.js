        ...
        if (serviceState === "idle") {
            switch (message.action) {
                case "grade":
                    ...
                    console.log("Assignments: ", instructions.assignments.length);
                    // const assignmentId = instructions.assignments.splice(0, 1)[0];

                    await Promise.allSettled(instructions.assignments.map(assignmentId => async ()=>{
                        console.log("Doing assignment:", assignmentId);
